...
let shareCodes = [
  'T76ufOSQ3-p1EnGXWSDoPw==@xw5kwX7qy1ZmmSkfSXJeLw==@TvjO5k4gaVqVHMRJIogd_g==@',//账号一的好友shareCode,不同好友中间用@符号隔开
  'T76ufOSQ3-p1EnGXWSDoPw==@xw5kwX7qy1ZmmSkfSXJeLw==@TvjO5k4gaVqVHMRJIogd_g==',//账号二的好友shareCode，不同好友中间用@符号隔开
]
